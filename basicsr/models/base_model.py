...
class BaseModel():
    ...
    def _initialize_best_metric_results(self, dataset_name):
        ...
        record['l_pieapp'] = dict(better='lower', val=float('inf'), iter=-1)
        record['l_pieapp_in_loss'] = dict(better='lower', val=float('inf'), iter=-1)
        record['l_pieapp_img'] = dict(better='lower', val=float('inf'), iter=-1)
    ...
    def get_optimizer(self, optim_type, params, lr, **kwargs):
        ...
        #     optimizer = AdamP(params, lr, **kwargs)
