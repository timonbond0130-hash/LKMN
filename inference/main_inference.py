...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='../pretrained_models/LKMN_T_x4.pth')
    parser.add_argument('--input', type=str, default='../datasets/Urban100/mod4/LRx4', help='input test image folder')
